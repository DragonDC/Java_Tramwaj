		...
		out.println("<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">"
				...
				+"<head/>"
					+ "<body>"
						...
						"Podaj adres zdjecia: <input type='textbox' id='button' name='zdjecie' value='' required><br /><br />" +
						
						"<input type='submit' id='button' class='btn btn-default' onClick='return(sprawdz_formularz());' value=' OK ' />" +
						"</form>" 
						+ "</div>"
